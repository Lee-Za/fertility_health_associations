...
eststo g
esttab a b c d e f g  using "$path_out/efghijkwomenbeta.rtf", replace not nonumbers legend stats(r2_a N, fmt (2 0) labels("korr. RÂ²""n"))  dmarker(,) label mtitle addnote("Data: Pairfam wave 7, own calculations") starlevel (* 0.05 ** 0.01 *** 0.001) rename(_cons "Constant") beta
...
esttab e f g h i j k l using efghijkl.rtf, replace not nonumbers legend stats(r2_a N, fmt (2 0) labels("korr. RÂ²""n"))  dmarker(,) label mtitle addnote("Data: Pairfam wave 7, own calculations") starlevel (* 0.05 ** 0.01 *** 0.001) rename(_cons "Constant")
